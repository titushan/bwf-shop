...
public class OrderService implements IOrderService {
    ...
    public boolean addOrder(OrderAddBo bo) {

        // 添加订单到 order 订单表
        int a = orderMapper.addOrder( bo.getOrder() );

        // 将订单详情列表 批量添加到 order_details 订单详情表
        int b = orderDetailMapper.addOrderDetailList( bo.getOrder().getId() , bo.getOrderDetailList() );
